...
# Incorrect calculation of totalVolumeOfBorrowersAmountinWei when withdraw Collateral from the protocol

### Summary

Incorrect calculation of totalVolumeOfBorrowersAmountinWei when withdraw Collateral from the protocol，resulting in withdraw DOS and Incorrect calculation of [CumulativeValue](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/CDSLib.sol#L494) , [cds pool value](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L666)

### Root Cause

Incorrect calculation of [totalVolumeOfBorrowersAmountinWei](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L920) when withdraw Collateral from the protocol

User deposit collateral into the protocol , `totalVolumeOfBorrowersAmountinWei` plus the [depositing amount in ETH](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L775)

But withdraw Collateral from the protocol,`totalVolumeOfBorrowersAmountinWei ` minus [depositDetail.depositedAmount](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L920) which is [not](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L739) amount in ETH
...
2.User [withdraw](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L804) collateral from the protocol

### Attack Path

1.CDS user1 deposit 10000000000 USDT
2.user2  [deposit ](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/Core_logic/borrowing.sol#L226)collateral  1 ETH ,current totalVolumeOfBorrowersAmountinWei = 1055252200646438689
3.user2 [withDraw](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/Core_logic/borrowing.sol#L281) ETH from the protocol,current totalVolumeOfBorrowersAmountinWei=55252200646438689n
4.user1 [withdraw](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/Core_logic/CDS.sol#L402) from CDS, then `calculateRatio`,due to [currentVaultValue]( https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L218) =0 leads to division  by zero

### Impact

1.CDS  user withdraw DOS
2.  Incorrect calculation of [CumulativeValue](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/CDSLib.sol#L494) , 
3.Incorrect calculation of [cds pool value](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L666)

### PoC

 File path : Blockchain/Blockchian/test/poc.ts 
...
describe("Borrowing Contract",function(){
    ...
    describe("CDS users should able to deposit and withdraw, if different collaterals deposited in Borrow", function(){
        ...
        it("test",async function(){
            ...
            await weETHA.connect(user2).approve(await BorrowingContractA.getAddress(), ethers.parseEther("10"));
            ...
            console.log("totalVolumeOfBorrowersAmountinWei after depositTokens",tx.totalVolumeOfBorrowersAmountinWei)
            
            const rate = await BorrowingContractA.connect(user2).calculateCumulativeRate();
            ...
            await BorrowingContractA.connect(user2).withDraw(
                ...
                timeStamp,
                {value: nativeFee});
            const tx2 = await globalVariablesA.getOmniChainData();
            console.log("totalVolumeOfBorrowersAmountinWei after Borrowing withDraw",tx2.totalVolumeOfBorrowersAmountinWei)
            console.log("vaultValue after Borrowing withDraw",tx2.vaultValue);
            //withsraw dos
