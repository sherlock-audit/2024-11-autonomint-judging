...
# USDa Gained  is always equal to 0

### Summary

USDa Gained during liquidation is always equal to 0.
[usdaGainedFromLiquidation](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L1002) is used to calculate abond usda ratio from liquidation.
However, there is no update USDa Gained in the[ liquidation contract](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/Core_logic/borrowLiquidation.sol#L174)

### Root Cause

[usdaGainedFromLiquidation](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L1002) is used to calculate abond usda ratio from liquidation.

When user [redeem](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L978) abond yields,`usdaGainedFromLiquidation` is used to calculate abond usda ratio from liquidation,then calculate [usdaToTransfer](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L1003)

However, there is no update USDa Gained in the[ liquidation contract](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/Core_logic/borrowLiquidation.sol#L174) lead to [usdaToTransfer](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L1019) is always equal to 0.
...
user [redeem](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L978) abond yields,

### Attack Path

1. Liquidate Borrow Position
2. User [withdraw](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/Core_logic/borrowing.sol#L281)  collateral from the protocol
3. User[ redeem](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/Core_logic/borrowing.sol#L318)  yields ,user cannot receive USDA token due to there is no update[ USDa Gained](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/lib/BorrowLib.sol#L1002) in the liquidation contract

### Impact

User cannot receive USDA token during [redeem](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/Core_logic/borrowing.sol#L318) yields
    ...
    describe("CDS users should able to deposit and withdraw, if different collaterals deposited in Borrow", function(){
        ...
        it("Should able to withdraw, if WeETH is liquidated in this chain borrow after initial deposit",async function(){
            ...
            await BorrowingContractB.connect(user2).withDraw(
                    ...
                    timeStamp,
                    {value: nativeFee});
            console.log("usdaGainedFromLiquidation",await treasuryB.usdaGainedFromLiquidation());
...
Update [USDAGainFromLiquidation](https://github.com/sherlock-audit/2024-11-autonomint/blob/0d324e04d4c0ca306e1ae4d4c65f0cb9d681751b/Blockchain/Blockchian/contracts/Core_logic/Treasury.sol#L422) in Treasury during liquidation